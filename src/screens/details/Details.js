            ...
            <div className="resDetails">
              ...
              <div>
                {(this.state.resData.categories || []).map(
                  (category, index) => {
                    return (
                      <span key={"span" + category.id} className="categories ">
              ...
              <br />
              <div>
                <span className="cusRating">
                  <i className="fa fa-star"></i>{" "}
                  {this.state.resData.customer_rating}
                </span>
                <span style={{ display: "block", color: "grey", fontSize: 20 }}>
                  AVERAGE RATING BY
                </span>
                          ...
                          <Grid item>
                            <Typography variant="caption" gutterBottom>
                              <IconButton
                                ...
                                className="padding-4 bold m-r-4"
                              ...
                              <IconButton
                                aria-label="Add Item"
                                className="padding-4 bold m-l-4"
