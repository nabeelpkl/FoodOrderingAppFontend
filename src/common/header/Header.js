...
class Header extends Component {
  ...
  render() {
    ...
    logoToRender = <Fastfood className={classes.icon} />;
    ...
    return (
      <div>
              ...
              <form>
                ...
                <FormControl required className={classes.formControl}>
                  ...
                  <FormHelperText className={this.state.emailRequired}>
                    <span className="red">required valid email</span>
                  </FormHelperText>
                </FormControl>
                <br />
                <br />
                ...
                >
                  ...
                  <FormHelperText className={this.state.passwordRegRequired}>
                    <span className="red">required strong password</span>
                  </FormHelperText>
                </FormControl>
                <br />
                <br />
        ...
        <Snackbar
          ...
          message={
            <span id="message-id">Registration Successful. Please Login!</span>
          }
          action={[
            <IconButton
              key="close"
